...
# Define the path for the counter file to store data in Docker Volume
...
def handle_request():
    ...
    if request.method == 'POST':
        ...
        return f'Current POST request count: {counter}'
...
def health_check():
    ...
    try:
        ...
        #Return unhealthy status if any error occurs, e.g., file access issues.
